#
#  Be sure to run `pod spec lint DataHandle.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Alkenso"
  # s.authors            = { "Alkenso" => "alkensox@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Alkenso"
  ...
  # s.public_header_files = "DataHandle/include/**/*.h"
